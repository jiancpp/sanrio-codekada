export const QuickAction = ({ title, icon, colorClass, isDark, sub, onClick }) => (
  <button onClick={onClick} className={`w-full p-4 rounded-2xl flex items-center gap-4 transition-all hover:opacity-90 active:scale-95
